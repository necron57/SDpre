...
public class Objective4Lab2 {
  public static void main(String[] args) {
    ...
    double dub4 = dubl1 + dubl2 + dubl3;

    

    System.out.println("The sum of " + numb1 + "+" + numb2 + "+" + numb3 + "=" + numb4); 
    System.out.println("The sum of " + dubl1 + "+" + dubl2 + "+" + dubl3 + "=" + dub4); 
